...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "netpack.py"

        #Name of program
        self.project_name = "Netpack"

        #Project url
        self.project_url = "http://www.royal-paw.com"
        ...
        #Auhor of program
        self.author_name = "Jamey DeOrio"
        self.author_email = "jamey@royal-paw.com"
        self.copyright = "Copyright (c) 2011 Royal Paw"

        #Description
        self.project_description = "A roguish arcade-like"

        #Icon file (None will use pygame default icon)
        self.icon_file = 'np_icon.ico'

        #Extra files/dirs copied to game
        self.extra_datas = ['snd', 'font.png', 'libtcod-mingw.dll', 'SDL.dll', 'README.txt', 'LIBTCOD-LICENSE.txt']
